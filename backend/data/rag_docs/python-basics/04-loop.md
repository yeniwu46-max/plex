...
## 5. range 参数与边界
`document_id: python-loop-range-detail`

掌握起点、终点、步长和反向区间。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：掌握起点、终点、步长和反向区间；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“range 参数与边界”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“range 参数与边界”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“range 参数与边界”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“range 参数与边界”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 6. enumerate 遍历
`document_id: python-loop-enumerate`

同时获取序列下标与元素。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：同时获取序列下标与元素；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“enumerate 遍历”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“enumerate 遍历”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“enumerate 遍历”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“enumerate 遍历”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 7. zip 并行遍历
`document_id: python-loop-zip`

同步遍历多个序列并处理长度差异。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：同步遍历多个序列并处理长度差异；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“zip 并行遍历”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“zip 并行遍历”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“zip 并行遍历”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“zip 并行遍历”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 8. 累加器模式
`document_id: python-loop-accumulator`

用循环完成求和、连乘与状态聚合。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用循环完成求和、连乘与状态聚合；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“累加器模式”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“累加器模式”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“累加器模式”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“累加器模式”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 9. 计数器模式
`document_id: python-loop-counter`

按条件累计次数并避免重复计数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：按条件累计次数并避免重复计数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“计数器模式”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“计数器模式”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“计数器模式”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“计数器模式”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 10. 哨兵循环
`document_id: python-loop-sentinel`

用特殊输入或状态控制未知次数循环。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用特殊输入或状态控制未知次数循环；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“哨兵循环”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“哨兵循环”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“哨兵循环”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“哨兵循环”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 11. 循环 else
`document_id: python-loop-else`

理解自然结束与 break 退出的差异。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：理解自然结束与 break 退出的差异；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“循环 else”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“循环 else”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“循环 else”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“循环 else”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 12. 列表推导式
`document_id: python-loop-comprehension`

把映射和筛选循环写成清晰推导式。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：把映射和筛选循环写成清晰推导式；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“列表推导式”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“列表推导式”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“列表推导式”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“列表推导式”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。


## 13. 循环复杂度直觉
`document_id: python-loop-complexity`

根据嵌套层数估算运行次数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：根据嵌套层数估算运行次数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“循环复杂度直觉”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“循环复杂度直觉”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“循环复杂度直觉”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“循环复杂度直觉”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“for Statements”“The range() Function”。
