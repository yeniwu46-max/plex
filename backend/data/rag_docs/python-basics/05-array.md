...
## 4. 列表切片
`document_id: python-array-slice`

使用切片复制、截取、步进和反转列表。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用切片复制、截取、步进和反转列表；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“列表切片”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“列表切片”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“列表切片”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“列表切片”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 5. 列表常用方法
`document_id: python-array-methods`

掌握 append、extend、insert、pop 与 remove。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：掌握 append、extend、insert、pop 与 remove；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“列表常用方法”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“列表常用方法”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“列表常用方法”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“列表常用方法”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 6. 浅拷贝与别名
`document_id: python-array-copy`

区分同一对象、浅拷贝与嵌套可变对象。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：区分同一对象、浅拷贝与嵌套可变对象；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“浅拷贝与别名”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“浅拷贝与别名”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“浅拷贝与别名”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“浅拷贝与别名”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 7. 元组与解包
`document_id: python-array-tuple`

使用不可变序列和结构化解包。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用不可变序列和结构化解包；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“元组与解包”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“元组与解包”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“元组与解包”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“元组与解包”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 8. 集合运算
`document_id: python-array-set`

完成去重、交并差与成员测试。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：完成去重、交并差与成员测试；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“集合运算”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“集合运算”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“集合运算”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“集合运算”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 9. 字典基础
`document_id: python-array-dict`

用键值映射完成查找、更新与遍历。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用键值映射完成查找、更新与遍历；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字典基础”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字典基础”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字典基础”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字典基础”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 10. 列表实现栈
`document_id: python-array-stack`

用后进先出结构处理撤销与括号问题。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用后进先出结构处理撤销与括号问题；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“列表实现栈”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“列表实现栈”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“列表实现栈”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“列表实现栈”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 11. 队列与 deque
`document_id: python-array-queue`

用先进先出结构组织待处理任务。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用先进先出结构组织待处理任务；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“队列与 deque”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“队列与 deque”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“队列与 deque”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“队列与 deque”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 12. 按键排序
`document_id: python-array-sort-key`

使用 sort、sorted、key 与 reverse。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用 sort、sorted、key 与 reverse；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“按键排序”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“按键排序”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“按键排序”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“按键排序”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。


## 13. 容器推导式
`document_id: python-array-comprehension`

生成列表、集合和字典并添加筛选条件。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：生成列表、集合和字典并添加筛选条件；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“容器推导式”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“容器推导式”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“容器推导式”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“容器推导式”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Data Structures”及 collections 标准库文档。
