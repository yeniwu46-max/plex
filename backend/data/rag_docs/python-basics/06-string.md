...
## 4. 字符串不可变性
`document_id: python-string-immutable`

理解修改字符串实际会创建新对象。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：理解修改字符串实际会创建新对象；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字符串不可变性”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字符串不可变性”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字符串不可变性”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字符串不可变性”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 5. 字符串格式化
`document_id: python-string-format`

使用 f-string 表达式、宽度、精度与填充。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用 f-string 表达式、宽度、精度与填充；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字符串格式化”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字符串格式化”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字符串格式化”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字符串格式化”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 6. 拆分与拼接
`document_id: python-string-split-join`

用 split 和 join 处理结构化文本。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用 split 和 join 处理结构化文本；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“拆分与拼接”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“拆分与拼接”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“拆分与拼接”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“拆分与拼接”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 7. 子串查找
`document_id: python-string-search`

使用 find、index、in 与 startswith。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用 find、index、in 与 startswith；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“子串查找”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“子串查找”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“子串查找”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“子串查找”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 8. 字符分类校验
`document_id: python-string-validate`

用 isdigit、isalpha 等检查输入格式。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用 isdigit、isalpha 等检查输入格式；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字符分类校验”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字符分类校验”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字符分类校验”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字符分类校验”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 9. 字符编码
`document_id: python-string-encoding`

理解 Unicode、UTF-8、编码与解码。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：理解 Unicode、UTF-8、编码与解码；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字符编码”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字符编码”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字符编码”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字符编码”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 10. 正则表达式入门
`document_id: python-string-regex`

用模式完成文本匹配、提取与替换。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用模式完成文本匹配、提取与替换；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“正则表达式入门”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“正则表达式入门”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“正则表达式入门”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“正则表达式入门”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 11. 字符频次统计
`document_id: python-string-frequency`

结合字典统计词频和字符频率。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：结合字典统计词频和字符频率；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“字符频次统计”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“字符频次统计”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“字符频次统计”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“字符频次统计”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 12. 回文与规范化
`document_id: python-string-palindrome`

在忽略空格和大小写后判断回文。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：在忽略空格和大小写后判断回文；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“回文与规范化”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“回文与规范化”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“回文与规范化”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“回文与规范化”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。


## 13. 文本文件处理
`document_id: python-string-file-text`

安全读写文本并逐行清洗数据。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：安全读写文本并逐行清洗数据；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“文本文件处理”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“文本文件处理”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“文本文件处理”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“文本文件处理”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 标准库 str、re、文本编码文档。
