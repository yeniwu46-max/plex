...
## 4. 作用域与生命周期
`document_id: python-func-scope`

理解局部、全局、nonlocal 与名称查找。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：理解局部、全局、nonlocal 与名称查找；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“作用域与生命周期”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“作用域与生命周期”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“作用域与生命周期”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“作用域与生命周期”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 5. 默认参数
`document_id: python-func-default`

设计默认值并规避可变默认参数陷阱。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：设计默认值并规避可变默认参数陷阱；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“默认参数”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“默认参数”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“默认参数”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“默认参数”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 6. 关键字参数
`document_id: python-func-keyword`

用参数名提升函数调用可读性。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用参数名提升函数调用可读性；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“关键字参数”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“关键字参数”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“关键字参数”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“关键字参数”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 7. 可变参数
`document_id: python-func-varargs`

使用 *args 与 **kwargs 接收不定参数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用 *args 与 **kwargs 接收不定参数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“可变参数”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“可变参数”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“可变参数”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“可变参数”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 8. lambda 表达式
`document_id: python-func-lambda`

为排序与映射编写短小匿名函数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：为排序与映射编写短小匿名函数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“lambda 表达式”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“lambda 表达式”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“lambda 表达式”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“lambda 表达式”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 9. 高阶函数
`document_id: python-func-higher-order`

把函数作为参数或返回值组织行为。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：把函数作为参数或返回值组织行为；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“高阶函数”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“高阶函数”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“高阶函数”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“高阶函数”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 10. 函数契约与文档
`document_id: python-func-contract`

明确输入、输出、异常和副作用。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：明确输入、输出、异常和副作用；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“函数契约与文档”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“函数契约与文档”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“函数契约与文档”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“函数契约与文档”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 11. 函数单元测试
`document_id: python-func-unit-test`

用正常、边界和异常用例验证函数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用正常、边界和异常用例验证函数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“函数单元测试”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“函数单元测试”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“函数单元测试”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“函数单元测试”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 12. 纯函数与副作用
`document_id: python-func-pure`

区分返回结果与修改外部状态。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：区分返回结果与修改外部状态；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“纯函数与副作用”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“纯函数与副作用”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“纯函数与副作用”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“纯函数与副作用”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。


## 13. 递归记忆化
`document_id: python-func-memoization`

缓存重复子问题以优化递归计算。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：缓存重复子问题以优化递归计算；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“递归记忆化”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“递归记忆化”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“递归记忆化”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“递归记忆化”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 3 官方教程“Defining Functions”及 unittest 文档。
