...
## 5. 时间复杂度
`document_id: python-search-complexity`

比较 O(1)、O(log n)、O(n) 与 O(n²)。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：比较 O(1)、O(log n)、O(n) 与 O(n²)；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“时间复杂度”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“时间复杂度”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“时间复杂度”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“时间复杂度”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 6. 二分边界模板
`document_id: python-search-boundary`

处理左闭右闭、左闭右开与重复元素边界。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：处理左闭右闭、左闭右开与重复元素边界；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“二分边界模板”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“二分边界模板”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“二分边界模板”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“二分边界模板”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 7. 冒泡排序
`document_id: python-search-bubble`

通过相邻交换逐轮确定最大元素。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：通过相邻交换逐轮确定最大元素；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“冒泡排序”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“冒泡排序”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“冒泡排序”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“冒泡排序”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 8. 选择排序
`document_id: python-search-selection`

每轮选择最值并放到已排序区。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：每轮选择最值并放到已排序区；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“选择排序”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“选择排序”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“选择排序”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“选择排序”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 9. 插入排序
`document_id: python-search-insertion`

维护已排序区并插入新元素。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：维护已排序区并插入新元素；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“插入排序”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“插入排序”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“插入排序”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“插入排序”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 10. 哈希查找
`document_id: python-search-hash`

利用集合和字典实现近似常数时间查找。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：利用集合和字典实现近似常数时间查找；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“哈希查找”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“哈希查找”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“哈希查找”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“哈希查找”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 11. 双指针搜索
`document_id: python-search-two-pointer`

用左右或快慢指针缩小搜索空间。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：用左右或快慢指针缩小搜索空间；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“双指针搜索”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“双指针搜索”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“双指针搜索”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“双指针搜索”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。


## 12. 广度优先搜索入门
`document_id: python-search-bfs`

使用队列按层搜索最短步数。本知识点在 PLEX 中作为独立诊断、练习和路径重规划单元，学习后应能解释规则、写出最小程序，并用边界输入验证结果。

- 概念：使用队列按层搜索最短步数；需要同时说清适用场景、输入输出和关键约束。
- 正例：围绕“广度优先搜索入门”先写一个最小可运行示例，再用正常值与边界值各运行一次，并说明每一步为何符合该知识点规则。
- 反例：不检查前提就机械套用“广度优先搜索入门”，或只验证一个样例便宣称程序正确；应通过最小反例定位错误并修正。
- 常见错误：混淆相近语法、遗漏边界条件、修改了不应修改的状态，以及输出格式与题意不一致。
- 基础题：用自己的话解释“广度优先搜索入门”，并编写一个不超过 10 行的 Python 小程序展示其最常见用法。
- 进阶题：为“广度优先搜索入门”设计正常、边界、异常三类测试，对两种实现的正确性、可读性和复杂度作比较。
- 来源：Python 官方教程数据结构章节与课程组算法复杂度讲义。
