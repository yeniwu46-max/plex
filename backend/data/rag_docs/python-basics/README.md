...
共 8 个模块、100 个知识点。核心节点包含完整讲义、代码正反例与练习答案；扩展节点包含可检索微课、正反例要求、常见错误及分层练习，并保留稳定的 `document_id` 与必填字段行。
...
100 个知识点均已有独立章节、稳定且唯一的 `document_id`，并包含概念、正反例、常见错误、基础题、进阶题和来源。运行以下命令验证契约：
