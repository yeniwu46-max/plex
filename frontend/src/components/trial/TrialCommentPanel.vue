...
<template>
  <div class="trial-comments">
    <div class="trial-comments__composer">
      ...
      />
      <n-button type="primary" size="small" class="trial-comments__submit" :loading="posting" @click="submitComment()">发布评论</n-button>
    </div>
